...
- oak_door: a real openable door, 2 blocks tall. Place it in a doorway as the ENTRANCE. Give it a "facing" field ("north"/"south"/"east"/"west") pointing OUT of the building toward where someone approaches (usually "south", the front). Place ONE oak_door entry at the bottom cell of the doorway (y=1); it automatically fills BOTH y=1 and y=2. CRITICAL: the doorway must be a 1-wide, 2-tall GAP in the wall — do NOT place any wall block at the door's position in y=1 OR y=2. Leave both of those cells empty except for the single oak_door entry, so the door isn't buried in the wall. Example: {"x":0,"y":1,"z":2,"block":"oak_door","facing":"south"}. Use a door instead of leaving an empty gap when the build is a house, cottage, castle, tower, or any enclosed building with an entrance.
